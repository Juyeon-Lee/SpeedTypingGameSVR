...
// SpeedTypingSvrDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "SpeedTypingSvr.h"
#include "SpeedTypingSvrDlg.h"
...
CSpeedTypingSvrDlg::CSpeedTypingSvrDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SPEEDTYPINGSVR_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CSpeedTypingSvrDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CSpeedTypingSvrDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CSpeedTypingSvrDlg 메시지 처리기

BOOL CSpeedTypingSvrDlg::OnInitDialog()
{
...
void CSpeedTypingSvrDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CSpeedTypingSvrDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CSpeedTypingSvrDlg::OnQueryDragIcon()
{
...
BOOL CSpeedTypingSvrDlg::PreTranslateMessage(MSG* pMsg)
{
